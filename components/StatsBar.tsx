...
export default function StatsBar() {
  ...
  return (
    ...
    >
      {/* Label */}
      <div className="flex items-center gap-4 px-5 md:px-8 pt-5 pb-3">
        <span
      ...
      <div className="relative overflow-hidden pb-5">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(to right, #2C1810 0%, transparent 100%)' }}
        />
        {/* Right fade */}
        <div
          className="absolute right-0 top-0 bottom-0 w-16 z-10 pointer-events-none"
          style={{ background: 'linear-gradient(to left, #2C1810 0%, transparent 100%)' }}
        />
          ...
          {ITEMS.map((item, i) =>
            item === null ? (
              <span
                ...
                style={{ fontSize: 10, color: 'rgba(255,255,255,0.35)', lineHeight: 1 }}
              >
                ·
              </span>
            ) : (
              <span
                ...
                style={{ fontSize: 11, color: '#ffffff', letterSpacing: '0.1em' }}
              >
                {item}
              </span>
            )
